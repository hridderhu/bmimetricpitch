...
```{r, fig.height=5.2, echo=FALSE, warning=FALSE}
# setting the plotsize
opar <- par()
par(pin=c(1, 1.5),lty=1, pch='.', mar=c(10, 4, 2, 0.5))
# calculating the area
length <- (140:210)
weight <- 25 * ((height/100)^2)
# plotting the information
plot(length,weight,type='l',xlab="", ylab="")
#lines(length,weight,lwd='2')
title(xlab="length [cm]", ylab="weight [kg]")
legend("topleft",legend='Overweighted',bty ="n", pch=NA)
# resetting the size
par(opar)
```
